      ...
      perSystem =
        ...
        let
          ...
          voicevox-models =
            lib.sourceByRegex
              (pkgs.fetchzip {
                url = "https://github.com/VOICEVOX/voicevox_vvm/archive/refs/tags/0.16.3.zip";
          ...
          voicevox-cuda-additional-libraries = pkgs.fetchzip {
            url = "https://github.com/VOICEVOX/voicevox_additional_libraries/releases/download/0.2.1/CUDA-linux-x64.zip";
            hash = "sha256-Y1RK0NhgoMQ4+Y6UAghg6EEf9qUCUww2bYHj5pjNpx4=";
          };
